...
from utils.general import (
    ...
    xyxy2xywh, clip_coords, plot_images, xywh2xyxy, box_iou, output_to_target, set_logging,ap_per_class)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--data', type=str, default='/home/dell/metric_uav/metric_detector/data/drone_select.yaml', help='*.data path')
    # parser.add_argument('--weights', type=str, default=r'best_drone.pt', help='model.pt path(s)')
    # parser.add_argument('--data', type=str, default=r'data/drone2.yaml', help='*.data path')
    ...
    parser.add_argument('--save-dir', type=str, default='/home/dell/metric_uav/metric_detector/runs/pred1', help='directory to save results')
