...
class DroneDetection():
    def __init__(self):
        ...
        parser.add_argument('--IRweights', nargs='+', type=str, default='/home/dell/Project_UAV/detect_wrapper/weights/best.pt', help='mdel.pt.path(s)')
        parser.add_argument('--RGBweights', nargs='+', type=str, default='/home/dell/Project_UAV/detect_wrapper/weights/best.pt', help='mdel.pt.path(s)')
