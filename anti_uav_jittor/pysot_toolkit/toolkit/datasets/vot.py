...
class VOTDataset(Dataset):
    ...
    def __init__(self, name, dataset_root, load_img=False):
        ...
        with open(os.path.join('pysot_toolkit/testing_dataset', name+'.json'), 'r') as f:
...
class VOTLTDataset(Dataset):
    ...
    def __init__(self, name, dataset_root, load_img=False):
        ...
        with open('D:\study\\track\TransT-main\TransT-main\pysot_toolkit\\testing_dataset\VOT2018.json', 'r') as f:
            meta_data = json.load(f)
